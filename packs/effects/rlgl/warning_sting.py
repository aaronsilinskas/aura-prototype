...
class WarningStingRenderer(EffectRenderer):
    """Audio-only renderer for the warning sting sound effect.
...
class WarningStingBuilder(EffectBuilder):
    def __call__(self, name: str, config: RendererConfig) -> WarningStingRenderer:
        return WarningStingRenderer()
