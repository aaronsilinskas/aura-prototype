"""Unit tests for packs.scenes.red_light_green_light.effects.red_light_music."""
...
def _build():
    from packs.scenes.red_light_green_light.effects.red_light_music import BUILD

    return BUILD("scene.red_light_music", _config())


def test_red_light_music_build_is_effect_builder() -> None:
...
def test_red_light_music_produces_no_pixel_output() -> None:
    effect = _build()

    assert effect.pixels is None


def test_red_light_music_emits_audio_on_start() -> None:
    effect = _build()

    assert "start" in effect.audio.clips


def test_red_light_music_audio_start_clip_name_is_scene_prefixed() -> None:
    ...
    assert effect.audio.clips["start"].name == "scene.red_light_music_start"


def test_red_light_music_audio_start_clip_loops() -> None:
    effect = _build()
